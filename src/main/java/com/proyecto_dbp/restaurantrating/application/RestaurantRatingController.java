...
public class RestaurantRatingController {
    ...
    public List<RestaurantRatingDTO> getCommentsByRestaurantId(@PathVariable Long restaurantId) {
        return restaurantRatingService.getCommentsByRestaurantId(restaurantId);
    }
